        ...
        <div className="mt-2 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <label className="flex items-center gap-1 text-xs text-slate-400">
              <span>Minutes</span>
              <input type="number" className="w-20 bg-slate-950 rounded px-2 py-1 text-xs" value={minutes} onChange={(e) => setMinutes(Math.max(30, Math.min(720, parseInt(e.target.value || 0, 10))))} />
            </label>
